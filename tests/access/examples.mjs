...
export const examples = {
  ...
  invitation_view: [{}, { invitation_id: 'invitation:one', revision: 1, ...invitation, state:'pending', accepted_grants:[],
  ...
  capabilities: [{}, { revision: 1, invitation_options:[], capabilities: [{ capability_id: 'reading', implemented: true, enabled: true, authorized: 'no', executable: 'no' }] }],
