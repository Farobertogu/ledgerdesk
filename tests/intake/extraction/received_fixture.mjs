...
export async function receivedOriginal(request,client,bytes,{name='synthetic.txt',format='text-utf8/1',media='text/plain'}={}){
  const declaration={profile:'intake/1',original:{name,bytes:bytes.length,sha256:createHash('sha256').update(bytes).digest('hex'),declared_media_type:media},
    format_profile:format,receiving_context:{scope_id:'organisation',purpose_id:'synthetic-reading-trial',treatment_revision:processingTreatment}};
