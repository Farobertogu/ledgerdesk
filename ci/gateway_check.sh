...
TESTS="tests/gateway/test_SEC_pii_never_leaves.mjs tests/gateway/test_GW_budget_cuts_off.mjs tests/gateway/test_GW_cache_hit_skips_call.mjs tests/gateway/test_GW_ledger_row_satisfies_contract.mjs"
